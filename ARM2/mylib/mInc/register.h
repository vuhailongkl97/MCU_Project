...
#define mSYSCFG_EXTICR2 (mBASE_SYSCFG +  0x0Cu)
#define mSYSCFG_EXTICR3 (mBASE_SYSCFG +  0x10u)
#define mSYSCFG_EXTICR4 (mBASE_SYSCFG +  0x14u)
...
#define mNVIC_ICER(x) (0XE000E180u + (4*x) )
#define mNVIC_ISPR(x) (0XE000E200u + (4*x))
#define mNVIC_ICPR(x) (0XE000E280u + (4*x))
